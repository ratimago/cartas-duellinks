            ...
            <div class="row">
                ...
                <div class="col s12 l9" id="prueba">
                    ...
                    <div class="descripcion center-align">                        
                        <p>La aplicación Volteo es una excelente combinación para tu camión ELF. Disfruta de su rendimiento y ligereza que ofrece la tecnología japonesa.Todos los ELF cuentan con frenos de disco en llantas delanteras y de tambor en las traseras, maximizando así el frenado aún con cargas muy pesadas.</p>
                    </div>
                </div>
            </div>
        </div>
