            ...
            <div class="row">
                ...
                <div class="col s12 l9" id="prueba">
                    ...
                    <div class="descripcion center-align">                        
                        <p>Camión basurero, aplicación para combinar con tu camión ELF. Disfruta de su rendimiento y capacidad de carga que ofrece la tecnología y diseño japones. Detalles tan simples como las manijas de apertura vertical muestran el enfoque de Isuzu en hacer vehículos más confortables y adaptados a las necesidades diarias de los operadores.</p>
                    </div>
                </div>
            </div>
        </div>
