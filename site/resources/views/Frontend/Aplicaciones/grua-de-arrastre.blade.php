            ...
            <div class="row">
                ...
                <div class="col s12 l9" id="prueba">
                    ...
                    <div class="descripcion center-align">                        
                        <p>Sin duda la aplicación Grúa de arrastre es excelente para combinar con tu camión ELF. Disfruta de su rendimiento y capacidad de carga que ofrece la tecnología y diseño japones. La experiencia empírica se ve reflejada en el diseño de la serie ELF.</p>
                    </div>
                </div>
            </div>
        </div>
