            ...
            <div class="row">
                ...
                <div class="col s12 l9" id="prueba">
                    ...
                    <div class="descripcion center-align">                        
                        <p>La aplicación Redillas es una excelente opción para combinar con tu camión ELF. Disfruta de su rendimiento y capacidad de carga que ofrece la tecnología y diseño japones. El área de las puertas está reforzada y el marco general fortalecido para mantener la integridad de la cabina, formando un capullo protector que limita el daño ocasionado en caso de algún accidente.</p>
                    </div>
                </div>
            </div>
        </div>
