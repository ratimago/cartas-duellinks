            ...
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="panel panel-default panel-form">
                    <div class="panel-body">
                        <h3 class="text-center">Configuración del bloque de Texto</h3>
                        {!!Form::Open(['url' => route('blocks.update',$id), 'files' => true, 'class' => "form-horizontal", 'role'=>'form'])!!}
                        {{-- Asignarle directamente a que bloque pertenece tips isuzu
                        <div class="form-group">
                            {!!Form::Label('staticmenu_id','Bloque:',['class'=>'col-md-3 control-label'])!!}
                            <div class="col-md-8">
