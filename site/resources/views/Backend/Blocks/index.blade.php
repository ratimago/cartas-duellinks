...
@section('title') Manipulación de Subsecciones @stop
@section('css')
            ...
            <div class="col-md-11 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Manipulación de Subsecciones</h3>
                    </div>
                    <div>
                        {!! $filters !!}
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        @if(!$list->isEmpty())
                            ...
                            <div class="text-left form-group">
                                ...
                                <a data-href="{{route('blocks.delete')}}" data-action="ELIMINAR"
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        @foreach($list as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->title }}</td>
                                                <td>{{ $item->subtitle }}</td>
                                                <td>{{ isset($item->staticmenu) ? $item->staticmenu->name : "Sección Eliminada" }}</td>
                                                <td>{{ \Backend::dateFormat($item->updated_at) }}</td>
                                                <td><a class="btn btn-default"
                                                       href="{{route('blocks.edit',$item->id)}}" data-toggle="tooltip" data-placement="top" title="Editar">Editar
                                                        <img src={{ asset("images/Pencil-icon.png") }} alt="imagen">
                                                    </a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-default"
                                                       href="{{route('gallery',['id' => $item->galleries->first(), 'type' => 'Block'])}}" data-toggle="tooltip" data-placement="top" title="Galería">Galería
