<div class="container-fluid">
    {!!Form::open(['url' => route('users.filter'),'class'=>'form form-vertical','role'=>'form'])!!}

    <div class="form-group col-sm-4">
        {!!Form::label('keyword','Buscar')!!}
        {!!Form::text('keyword', $filters['keyword'], ['placeholder'=>'Nombre de usuario','class'=>'form-control'])!!}
    </div>
    <div class="form-group col-sm-2">
        {!!Form::label('role_id','Tipo Usuario')!!}
        {!!Form::select('role_id', ['' => 'Seleccionar'] + $extra['roles'], $filters['role_id'],['class'=>'form-control'])!!}
    </div>
    <div class="form-group col-sm-2">
    ...
    <div class="text-left form-group btn-group col-sm-12">
        ...
        <a class="btn btn-warning" href="{{route('users.filter')}}"><i class="glyphicon glyphicon-refresh"></i> Limpiar
            Filtros</a>
        ...
        <a href="{{ route('users.excel') }}" class="btn btn-info">
