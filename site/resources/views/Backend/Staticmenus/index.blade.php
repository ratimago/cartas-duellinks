...
@section('title') Manipulación de Menús @stop
@section('css')
            ...
            <div class="col-md-11 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Manipulación de Secciones</h3>
                    </div>
                    <div>
                        {!! $filters !!}
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        @if(!$list->isEmpty())
                            ...
                            <div class="text-left form-group">
                                ...
                                <a data-href="{{route('staticmenus.delete')}}" data-action="ELIMINAR"
                                        ...
                                        @foreach($list as $item)
                                            <tr>
                                                ...
                                                <td><a class="btn btn-default"
                                                       href="{{route('staticmenus.edit',$item->id)}}" data-toggle="tooltip" data-placement="top" title="Editar">
                                                        <img src={{ asset("images/Pencil-icon.png") }} alt="imagen">
                                                    </a>
{{--                                                <a class="btn btn-primary"
                                                       href="{{route('staticmenus.blocks',$item->id)}}">
                                                        <span class="glyphicon glyphicon-edit"></span>Subsecciones</a>--}}
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
