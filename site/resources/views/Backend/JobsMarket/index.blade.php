...
@section('title') Bolsa de Trabajo @stop
@section('css')
            ...
            <div class="col-md-11 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Bolsa de Trabajo</h3>
                    </div>
                    <div>
                        {!! $filters !!}
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        @if(!$list->isEmpty())
                            ...
                            <div class="text-left form-group">
                                ...
                                <a data-href="{{route('jobsmarket.delete')}}" data-action="ELIMINAR"
                                            ...
                                            <tr>
                                               ...
                                               {{-- <td>{{ $item->state->name }}</td>--}}
                                                ...
                                                <td><a class="btn btn-default"
                                                       href="{{route('jobsmarket.edit',$item->id)}}" data-toggle="tooltip" data-placement="top" title="Ver Detalles">
                                                        <img src={{ asset("images/Actions-view-list-details-icon.png") }} alt="Detalles">Visualizar</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
