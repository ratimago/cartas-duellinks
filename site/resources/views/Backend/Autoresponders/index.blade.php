...
@section('title') Configuración de Mensajes de Autorespuesta @stop
@section('css')
            ...
            <div class="col-md-11 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Configuración de Mensajes de Autorespuesta</h3>
                    </div>
                    <div>
                        {!! $filters !!}
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        @if(!$list->isEmpty())
                            ...
                            <div class="text-left form-group">
                                ...
                                <a data-href="{{route('autoresponders.delete')}}" data-action="ELIMINAR"
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        @foreach($list as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        @foreach(\Backend::getList($item->addressee_mail, ',') as $data)
                                                            @if(!empty($data))
                                                                <li>{{ $data }}</li>
                                                            @endif
                                                        @endforeach
                                                ...
                                                <td><a class="btn btn-default"
                                                       href="{{route('autoresponders.edit',$item->id)}}" data-toggle="tooltip" data-placement="top" title="Editar">Editar
