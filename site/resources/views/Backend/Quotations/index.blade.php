...
@section('title') Cotizaciones | Financiamiento | Contacto @stop
@section('css')
            ...
            <div class="col-md-11 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Cotizaciones | Financiamiento | Contacto</h3>
                    </div>
                    <div>
                        {!! $filters !!}
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        @if(!$list->isEmpty())
                            ...
                            <div class="text-left form-group">
                                ...
                                <a data-href="{{route('quotations.delete')}}" data-action="ELIMINAR"
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        @foreach($list as $item)
                                            <tr>
                                                ...
                                                <td>({{ $item->area_code }})  {{ $item->phone }}</td>
                                                <td>{{ $item->company_name }}</td>
                                                <td>{{ \Backend::dateFormat($item->created_at) }}</td>
                                                <td><a class="btn btn-default"
                                                       href="{{route('quotations.edit',$item->id)}}" data-toggle="tooltip" data-placement="top" title="Ver Detalles">
                                                        <img src={{ asset("images/Actions-view-list-details-icon.png") }} alt="Detalles">Visualizar</a></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
